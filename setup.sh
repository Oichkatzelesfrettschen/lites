...
##
# \brief Install a package using multiple package managers.
#
# Attempts apt-get first and falls back to pip or npm if necessary. Custom
# handling for specific packages is provided when applicable.
#
...
# List of packages to be installed via install_pkg. Only valid package names
# should appear here so apt-get runs cleanly.
packages=(
